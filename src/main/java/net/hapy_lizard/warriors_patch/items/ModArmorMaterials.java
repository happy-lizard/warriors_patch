...
public enum ModArmorMaterials implements ArmorMaterial {
    BLESSED_MASK("blessed_mask", 28, new int[]{100, 100, 100, 100}, 20, SoundEvents.ARMOR_EQUIP_LEATHER,
            100.0F, 1.2F, () -> Ingredient.of(ModItems.BLESSED_WOOD.get()));

    private static final int[] HEALTH_PER_SLOT = new int[]{90, 15, 16, 11};
    ...
    public String getName() {
        return warriors_patch.MOD_ID + ":" + this.name;
    }
